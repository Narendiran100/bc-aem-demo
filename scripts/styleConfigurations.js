window.styleConfiguration = {
  ...
  "behavior": {
    ...
    "privacyNotice": {
      ...
      "text": "Your use of this automated chatbot constitutes your consent that the personal information you provide in the chat session \n      can be collected, used, disclosed, and retained by KrisShop and service providers acting on KrisShop's behalf \n      in accordance with the KrisShop {Privacy Policy}. Please do not provide sensitive personal information \n      (such as financial or health information) in the chatbot.",
      "links": [
        {
          "text": "Privacy Policy",
  ...
  "text": {
    "welcome.heading": "Explore what you can do with KrisShop.",
  ...
  "arrays": {
    "welcome.examples": [
      {
          text: "Travel size skincare",
          image:
            "https://s7ap1.scene7.com/is/image/krisshop/BB600696_1?fmt=webp",
          backgroundColor: "#FFFFFF",
        },
        {
          text: "Show luxury watches",
          image:
              "https://s7ap1.scene7.com/is/image/krisshop/B%201069%20S-MP1?fmt=webp",
          backgroundColor: "#FFFFFF",
          },
        {
          text: "Show me duty-free drinks",
          image:
            "https://s7ap1.scene7.com/is/image/krisshop/Jack_Daniel_s_Gentleman_Jack_Tennessee_Whiskey_1L_Gift_VAP_82184038734?fmt=webp",
          backgroundColor: "#FFFFFF",
        }
      ],
  ...
  "theme": {
    ...
    "--input-outline-color": "linear-gradient(98.11deg,rgb(13, 12, 13) -4.21%,rgb(215, 211, 215) 35.46%,rgb(29, 28, 28) 68.67%,rgb(241, 238, 236) 104.7%)",
